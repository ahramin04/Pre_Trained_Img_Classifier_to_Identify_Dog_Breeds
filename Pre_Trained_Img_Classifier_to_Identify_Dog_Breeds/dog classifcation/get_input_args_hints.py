...
def get_input_args():
    ...
    parser.add_argument('--dir', type=str, default='pet_images/', 
                        help='path to folder of images- default: pet_images/')
    ...
    parser.add_argument('--arch',type = str , default = 'vgg',help = 'CNN model architecture to be used - default: VGG' )
    parser.add_argument('--dogfile',type = str, default = 'dognames.txt' ,help = 'text file containing dog names - default: dognames.txt' )
